...
export const marketStories = [
  {
    ...
    text: '',
    result: '¥2M+ generated through infrastructure.',
  ...
  },
  {
    ...
    text: '',
    result: '$100K+ revenue through systems.',
  ...
  },
  {
    ...
    text: '',
    result: 'Trust before the first conversation.',
  ...
  },
  {
    ...
    text: '',
    result: 'Infrastructure before scale.',
...
export const resultMetrics = [
  ...
  },
  {
    number: 'Lower CPL',
    label: 'lower CPL',
    detail: 'Cleaner pages and campaigns reduce wasted demand.',
    start: 6,
    end: 31,
    negative: true,
  },
